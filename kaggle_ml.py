...
print(np.mean(cross_val_score(pipe, data_dummies_df, y_train, cv=5, scoring="roc_auc")))
...
print(np.mean(cross_val_score(pipe_lrk, data_dummies_df, y_train, cv=5, scoring="roc_auc")))
...
print(np.mean(cross_val_score(pipe_fs, data_dummies_df, y_train, cv=5, scoring="roc_auc")))
...
print(np.mean(cross_val_score(pipe_lassocv, data_dummies_df, y_train, cv=10, scoring="roc_auc")))
